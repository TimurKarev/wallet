...
class FirebaseAppleSignInUseCase extends SignInUseCase {
  FirebaseAppleSignInUseCase(this._repo);

  final AuthRepository _repo;

  @override
  Future<Either<AuthFailure, Unit>> signIn() async => _repo.signInWithApple();
}
