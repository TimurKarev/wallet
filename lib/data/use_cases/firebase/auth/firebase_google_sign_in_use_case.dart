...
class FirebaseGoogleSignInUseCase extends SignInUseCase {
  FirebaseGoogleSignInUseCase(this._repo);

  final AuthRepository _repo;

  @override
  Future<Either<AuthFailure, Unit>> signIn() async => _repo.signInWithGoogle();
}
